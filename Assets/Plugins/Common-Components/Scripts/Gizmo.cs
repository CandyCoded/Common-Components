            ...
            switch (type)
            {
                ...
                case GizmoTypes.Line:
                    if (relativeEndPosition)
                    {
                        ...
                        Gizmos.DrawLine(gameObject.transform.position + offset,
                            gameObject.transform.position + offset + endPosition);
...
#pragma warning disable S131, IDE0010
                ...
                switch (script.type)
                {
                    ...
                    case GizmoTypes.Line:
                        ...
                        script.relativeEndPosition =
                            EditorGUILayout.Toggle("Relative End Position", script.relativeEndPosition);
